...
transformCase :: [PatProgramElement] -> Expr Pattern -> Expr Pattern
...
transformCaseProduct :: NameSupply -> [PatProgramElement] -> Expr Pattern -> [Alter Pattern Pattern] -> Expr Pattern
--TODO: tempporarily use transformCaseSum, fix later to own implementation
transformCaseProduct = transformCaseSum


transformCaseSum :: NameSupply -> [PatProgramElement] -> Expr Pattern -> [Alter Pattern Pattern] -> Expr Pattern
...
transformCaseSimple :: NameSupply -> [PatProgramElement] -> Expr Pattern -> [Alter Pattern Pattern] -> Expr Pattern
...
transformCaseConstr :: NameSupply -> [PatProgramElement] -> Expr Pattern -> [Alter Pattern Pattern] -> Expr Pattern
